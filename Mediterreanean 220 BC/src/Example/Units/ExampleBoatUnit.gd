...
onready var body = $MeshInstance2/BodyMesh
...
#	look_at(-target_pos, Vector3(0,1,0))
	SoundManager.play_se("res://Assets/Sound/Ships/Ship_response_3.wav", 0, -15)
...
func select(group_num):
	match group_num:
		0:
			SoundManager.play_se("res://Assets/Sound/Ships/Ship_response_1.wav")
		1:
			SoundManager.play_se("res://Assets/Sound/Ships/Ship_response_2.wav")
	$SelectionArrow.show()
